...
class StoreJobPostRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'shift_type' => ['required', 'string', 'in:full_time,part_time,2_shift,3_shift,event,temporary'],
            ...
            'required_certificate_level' => ['required', 'string', 'in:none,gada_pratama,gada_madya,gada_utama'],
