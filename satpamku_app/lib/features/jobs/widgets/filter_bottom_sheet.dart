          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                children: [
                  _buildChoiceChip('Terbaru', 'newest', _selectedSort, (val) => setState(() => _selectedSort = val ?? 'newest')),
                  _buildChoiceChip('Gaji Tertinggi', 'salary_desc', _selectedSort, (val) => setState(() => _selectedSort = val ?? 'newest')),
                  _buildChoiceChip('Paling Mendesak', 'urgent', _selectedSort, (val) => setState(() => _selectedSort = val ?? 'newest')),
                  _buildChoiceChip('Paling Banyak Dilihat', 'popular', _selectedSort, (val) => setState(() => _selectedSort = val ?? 'newest')),
                ],
              ),
